...
from .run_method import run_bitbertgcn_for_direct_seperation
...
best_metrics, ckpt_dir = run_bitbertgcn_for_direct_seperation(config)
...
logger.log(config, best_metrics, 
            model_name="bitbertgcn_direct_seperation", project_name="bitbertgcn_direct_seperation",
            ckpt_dir=ckpt_dir)
