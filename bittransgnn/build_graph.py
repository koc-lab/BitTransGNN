...
if __name__ == "__main__":
    ...
    for dataset in datasets:
        ...
        f = open('dataset/' + dataset + '.test.index', 'w')
        ...
        f = open("dataset/ind.{}.tx".format(dataset), 'wb')
        pkl.dump(tx, f)
        f.close()

        f = open("dataset/ind.{}.ty".format(dataset), 'wb')
        pkl.dump(ty, f)
        f.close()
...
#stsb için değişiklik var, file write var
"""
import random
import numpy as np
import pickle as pkl
...
for dataset in datasets:
    ...
    print(dataset)
    # Read Word Vectors
    # word_vector_file = 'dataset/glove.6B/glove.6B.300d.txt'
    # word_vector_file = 'dataset/corpus/' + dataset + '_word_vectors.txt'
    ...
    f = open('dataset/corpus/' + dataset + '_vocab_def.txt', 'w')
    f.write(string)
    f.close()
    ...
    f = open('dataset/corpus/' + dataset + '_word_vectors.txt', 'w')
    f.write(string)
    f.close()
...
"""
#file writelar yok, stsb için değişiklik var
import random
import numpy as np
import pickle as pkl
import scipy.sparse as sp
